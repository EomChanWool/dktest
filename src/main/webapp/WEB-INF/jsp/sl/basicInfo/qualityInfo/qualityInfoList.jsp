...
<body id="page-top">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
							<div class="search">
	                            ...
	                            <a href="#" class="btn btn-primary btn-icon-split" onclick="fn_regist_qualityInfo()" style="float: right;">
                                    	...
                                    	<c:forEach var="result" items="${qualityInfoList}" varStatus="status">
	                                   		<tr>
	                                            ...
	                                            <td style="padding: 5px 0px;">
	                                            	<a href="#" class="btn btn-warning btn-icon-split" onclick="fn_modify_qualityInfo_go('${result.pIdx}')">
				                                        <span class="text">수정</span>
				                                    </a>
				                                    <a href="#" class="btn btn-danger btn-icon-split" onclick="fn_delete_qualityInfo('${result.pIdx}')">
	...
	<script>
		...
		function fn_modify_qualityInfo_go(idx){
