        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">목표관리 등록</h1>
                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <div class="table-responsive">
                            	<form action="${pageContext.request.contextPath}/sl/basicInfo/goal/registGoalOk.do" name="registForm" method="post">
	                                <table class="table table-bordered" id="dataTable">
	                                    <tbody>
											<tr>
												<th>목표년도 <span class="req">*</span></th>
												<td><select class="form-control" name="gmYear" id="gmYear">
							    		...
							    		<c:forEach begin="1" end="12" varStatus="status">
											...
											<tr>
												...
												<td><input type="text" class="form-control" name="gmBadRate" id="gmBadRate"/></td>
												<th></th>
												<td></td>
											</tr>
										</tbody>
