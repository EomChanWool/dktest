...
<body id="page-top">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
							<div class="search">
								<form name ="listForm" class="listForm" action="${pageContext.request.contextPath}/sl/basicInfo/program/programList.do" method="post">
						    		...
						    		<select  class="btn btn-secondary dropdown-toggle searchCondition" name="searchCondition" id="searchCondition">
							    		...
							    		<option value="기준정보관리" <c:if test="${searchVO.searchCondition eq '기준정보관리'}">selected="selected"</c:if>>LOT번호</option>
							    		<option value="영업관리" <c:if test="${searchVO.searchCondition eq '영업관리'}">selected="selected"</c:if>>발주번호</option>
	...
	function fn_regist_program(){
		listForm.action = "${pageContext.request.contextPath}/sl/basicInfo/program/registProgram.do";
		listForm.submit();
	}
	
	function fn_modify_program_go(idx){
		listForm.pIdx.value = idx;
		listForm.action = "${pageContext.request.contextPath}/sl/basicInfo/program/modifyProgram.do";
		listForm.submit();
	}
	...
	function fn_delete_program(idx){
		if(confirm('해당 내역을 삭제하시겠습니까?')) {
			listForm.pIdx.value = idx;
			listForm.action = "${pageContext.request.contextPath}/sl/basicInfo/program/deleteProgram.do";
			listForm.submit();
		}
	}
