                            	...
                            	<form action="${pageContext.request.contextPath}/sl/basicInfo/item/registItemOk.do" name="registForm" method="post">
	                                <table class="table table-bordered" id="dataTable">
	                                    <tbody>
											...
											<tr>
												<th>규격</th>
												<td><input type="text" class="form-control" name="itemStd"/></td>
												<th>단가</th>
												<td><input type="text" class="form-control" name="itemPerPrice"/></td>
											</tr>
											<tr>
												<th>비고</th>
												<td colspan="3"><textArea name="itemNote"></textArea></td>
											</tr>
										</tbody>
	                                </table>
                                </form>
