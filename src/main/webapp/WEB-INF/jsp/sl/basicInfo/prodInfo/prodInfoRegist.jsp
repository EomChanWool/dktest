	                                ...
	                                <table class="table table-bordered" id="dataTable">
	                                    <tbody>
											<tr>
												...
												<td><input type="text" class="form-control" name="prodInfoName" id="prodInfoName"/></td>
											</tr>
											<tr>
												<th>규격</th>
												<td><input type="text" class="form-control" name="prodInfoStd"/></td>
												<th>단가</th>
												<td><input type="text" class="form-control" name="prodInfoPerPrice"/></td>
											</tr>
											<tr>
												<th>비고</th>
												<td colspan="3"><textArea name="prodInfoNote"></textArea></td>
											</tr>
										</tbody>
	                                </table>
                                </form>
