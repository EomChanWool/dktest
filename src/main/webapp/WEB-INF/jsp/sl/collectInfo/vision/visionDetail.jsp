        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">비전검사정보 상세보기</h1>
                    <!-- DataTales Example -->
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
										...
										<tr>
											...
											<td colspan="3">
												<span class="form-control val-area">
													<a href="${pageContext.request.contextPath}/sl/collectInfo/vision/downloadVision.do?fileName=${detail.idDoc}">
                                ...
                                <div class="btn_bottom_wrap">
									<span class="btn_cancel" onclick="location.href='${pageContext.request.contextPath}/sl/collectInfo/vision/visionList.do'">목록</span>
								</div>
                            </div>
                        </div>
                    </div>
