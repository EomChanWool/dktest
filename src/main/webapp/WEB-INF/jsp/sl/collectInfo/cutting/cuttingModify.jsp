                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <div class="table-responsive">
                            	<form action="${pageContext.request.contextPath}/sl/collectInfo/cutting/modifyCuttingOk.do" name="modifyForm" method="post">
                            		<input type="hidden" name="esIdx" value="${cuttingVO.esIdx}">
	                                <table class="table table-bordered" id="dataTable">
	                                    <tbody>
										<tr>
											<th>견적서 제목</th>
											<td><input type="text" class="form-control" name="esName" value="${cuttingVO.esName}"/></td>
											<th>자사 담당자</th>
											<td><input type="text" class="form-control" name="esComManager" value="${cuttingVO.esComManager}"/></td>
										</tr>
										<tr>
											...
											<td>
												<select class="form-control" name="cIdx" id="cIdx">
													...
													<c:forEach var="list" items="${compnayList}" varStatus="status">
														<option value="${list.cIdx}" <c:if test="${cuttingVO.cIdx eq list.cIdx}">selected="selected"</c:if>>${list.cName}</option>
													</c:forEach>
												</select>
											</td>
											...
											<td>
												<select class="form-control" name="aIdx" id="aIdx">
													...
													<c:forEach var="list" items="${accountList}" varStatus="status">
														<option value="${list.aIdx}" <c:if test="${cuttingVO.aIdx eq list.aIdx}">selected="seletec"</c:if>>${list.aName}</option>
													</c:forEach>
												</select>
											</td>
										</tr>
										...
										<tr>
											<th>비고</th>
											<td colspan="3"><textArea name="esNote">${cuttingVO.esNote}</textArea></td>
										</tr>
									</tbody>
	                                </table>
	                                <table class="table table-bordered" id="dataTable">
