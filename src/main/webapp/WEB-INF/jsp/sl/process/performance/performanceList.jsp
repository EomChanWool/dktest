...
<body id="page-top">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
							<div class="search">
								<form name ="listForm" class="listForm" action="${pageContext.request.contextPath}/sl/process/performance/performanceList.do" method="post">
					    			...
					    			<select class="btn btn-secondary dropdown-toggle searchCondition" name="searchCondition" id="searchCondition">
							    		...
							    		<option value="제품" <c:if test="${searchVO.searchCondition eq '제품'}">selected="selected"</c:if>>LOT</option>
							    		<option value="자재" <c:if test="${searchVO.searchCondition eq '자재'}">selected="selected"</c:if>>제품코드</option>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable"  >
                                    ...
                                    <tbody>
                                    	...
                                    	<c:if test="${empty performanceList}"><tr><td colspan='10'>결과가 없습니다.</td><del></del></c:if>
                                    </tbody>
                                </table>
                                <div class="btn_page">
	...
	<script>
		...
		function fn_regist_document(){
			listForm.action = "${pageContext.request.contextPath}/sl/process/performance/registPerformance.do";
			listForm.submit();
		}
	
		function fn_modify_document_go(doIdx){
			listForm.doIdx.value = doIdx;
			listForm.action = "${pageContext.request.contextPath}/sl/process/performance/modifyPerformance.do";
			listForm.submit();
		}
		
		function fn_detail_document(doIdx){
			listForm.doIdx.value = doIdx;
			listForm.action = "${pageContext.request.contextPath}/sl/process/performance/detailPerformance.do";
			listForm.submit();
		}
		...
		function fn_delete_document(doIdx, nm){
			if(confirm('해당 내역을 삭제 하시겠습니까?')) {
				...
				listForm.action = "${pageContext.request.contextPath}/sl/process/performance/deletePerformance.do";
				listForm.submit();
			}
		}
