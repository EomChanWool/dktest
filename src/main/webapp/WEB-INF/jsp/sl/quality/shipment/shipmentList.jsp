        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">출하 계획/지시 관리</h1>
                                    ...
                                    <tbody>
                                    	<c:forEach var="result" items="${shipmentList}" varStatus="status">
	                                   		<tr>
	                                            <td>${result.aName}</td>
												<td>${result.orName}</td>
												<td>${result.shPlace}</td>
												<td>${result.aTel}</td>
												<td>${result.shReqDte}</td>
                                    	...
                                    	<c:if test="${empty shipmentList}"><tr><td colspan='6'>결과가 없습니다.</td><del></del></c:if>
                                    </tbody>
                                </table>
                                <div class="btn_page">
