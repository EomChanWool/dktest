        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">출하 계획/지시 상세</h1>
                    <!-- DataTales Example -->
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable">
                                    <tbody>
										<tr>
											<th>거래처 </th>
											<td><span class="form-control val-area">${shipmentVO.aName}</span></td>
											<th>거래처주소</th>
											<td><span class="form-control val-arae">${shipmentVO.aAddr}</span></td>
										</tr>
										<tr>
											<th>거래처연락처</th>
											<td><input type="text" name="aTel" id="aTel" value="${shipmentVO.aTel}"></td>
											<th>납품지  <span class="req">*</span></th>
											<td><input type="text" name="shPlace" id="shPlace" value="${shipmentVO.shPlace}"></td>
										</tr>
										<tr>
											<th>수주명</th>
											<td><span class="form-control val-area">${shipmentVO.orName}</span></td>
											<th>출하요청일  <span class="req">*</span></th>
											<td><span class="form-control val-area">${shipmentVO.shReqDte}</span></td>
										</tr>
										<tr>
											<th>담당자</th>
											<td colspan="3"><span class="form-control val-area">${shipmentVO.shManager}</span></td>
										</tr>
									</tbody>
                                </table>
