                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <div class="table-responsive">
                            	<form action="${pageContext.request.contextPath}/sl/monitoring/monitorSetting/monitorSettingRegistOk.do" name="registForm" method="post">
	                                <table class="table table-bordered" id="dataTable">
	                                    <tbody>
											<tr>
											<th>메뉴  <span class="req">*</span></th>
												<td>
													<input type="text" class="form-control" name="setId" id="setId" list="list" autocomplete="off">
												<datalist id="list">
													<option value="">선택</option>
													<c:forEach var="list" items="${setList}" varStatus="status">
														<option value="${list.setId}">${list.setId} / ${list.setName}</option>
													</c:forEach>
												</datalist>
												</td>
                                ...
                                <div class="btn_bottom_wrap">
									<button type="submit" class="btn_ok" onclick="fn_regist_set()" style="border:none;">확인</button>
